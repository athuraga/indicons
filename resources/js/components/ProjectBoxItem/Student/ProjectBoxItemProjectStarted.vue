    ...
    <div class="project-box__top-container">
      ...
      <div class="project-box__item--container">
        ...
        <div class="project-box__item--status" :class="color">
          <span class="iconify" data-icon="mdi-alpha-s-circle-outline" width="20" height="20" />
      ...
      <div v-if="$matchMedia.xl" class="project-box__bottom-container">
        <router-link :to="{ name: 'project.dashboard', params: { id: data.project.project_url } }" class="btn btn--blue" tag="button">
          See Dashboard
        </router-link>
      </div>
    </div>
