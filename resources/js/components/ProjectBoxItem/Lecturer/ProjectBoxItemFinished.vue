    ...
    <div class="project-box__top-container">
      ...
      <div class="project-box__item--container">
        ...
        <div class="project-box__item--status" :class="color">
          <span class="iconify" data-icon="el:flag" width="20" height="20" />
          <span>Project Finished</span>
        </div>

        <div v-if="$matchMedia.xl">
          <p class="project-box__item--p">
            Your "{{ data.project.title }}" have already been finished. You can see the project on you biography for more details.
          </p>
        </div>
